...
const Transactions = () => {
    ...
    const fetchAllTransactionData = useCallback(async (pageNumber = 1, pageSize = 10) => {
        setLoading(true);
        try {
    ...
    useEffect(() => {
        fetchAllTransactionData(page, limit);
    }, [filterType, paymentStatus, customStartDate, customEndDate, userId, page, limit, fetchAllTransactionData]);
