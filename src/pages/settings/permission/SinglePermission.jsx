...
//             );
//             formatted[menu.name] = {
//                 canView: rolePermission?.subMenus.every((sub) => sub.canView) || false,
...
//                         Are you sure you want to update the permissions for this role?
//                         This action will override all existing permissions and cannot be undone.
//                     </Typography>
//                     {/* Render permissions table or additional information here if necessary */}
//                 </DialogContent>
//                 <DialogActions>
...
//                     return {
//                         name: subMenu.name,
//                         isChecked: subPermission ? true : false,
//                         canView: subPermission?.canView || false,
//                         canEdit: subPermission?.canEdit || false,
//                         canDelete: subPermission?.canDelete || false,
//                         canAdd: subPermission?.canAdd || false,
...
//                                                     )?.isChecked || false
//                                                 }
//                                                 disabled={!permissions[menu.name]?.isChecked} // Disabled if main link is not checked
//                                                 onChange={(e) =>
//                                                     handleSubMenuChange(
//                                                         menu.name,
//                                                         subMenu.name,
...
//                                                         }
//                                                         disabled={
//                                                             !permissions[menu.name]?.isChecked || // Disabled if main link is not checked
//                                                             !permissions[menu.name]?.subMenus.find(
//                                                                 (sub) => sub.name === subMenu.name
//                                                             )?.isChecked // Disabled if sub-link is not checked
//                                                         }
//                                                         onChange={(e) =>
//                                                             handleCrudChange(
//                                                                 menu.name,
...
//                                                     />
//                                                 }
//                                                 label={crudType.replace("can", "")} // Display CRUD as "View", "Edit", etc.
//                                             />
//                                         ))}
//                                     </Box>
//                                 </Grid>
